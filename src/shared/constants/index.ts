...
export const API_ROUTES = {
    ...
    backings: {
        ...
        create: (campaniaId: string) => `/api/campanias/${campaniaId}/backings`,
    ...
    crowdsourcing: {
        ...
        acuerdos: {
            ...
            milestones: (acuerdoId: string) => `/api/crowdsourcing/acuerdos/${acuerdoId}/milestones`,
            milestoneById: (acuerdoId: string, id: string) => `/api/crowdsourcing/acuerdos/${acuerdoId}/milestones/${id}`,
            entregables: (acuerdoId: string) => `/api/crowdsourcing/acuerdos/${acuerdoId}/entregables`,
        },
        entregables: {
    ...
    crowdpromotion: {
        ...
        programas: {
            ...
            inscripcion: (programaId: string) => `/api/crowdpromotion/programas/${programaId}/inscripcion`,
            inscripciones: (programaId: string) => `/api/crowdpromotion/programas/${programaId}/inscripciones`,
            aprobar: (programaId: string, inscripcionId: string) => `/api/crowdpromotion/programas/${programaId}/inscripciones/${inscripcionId}/aprobar`,
            rechazar: (programaId: string, inscripcionId: string) => `/api/crowdpromotion/programas/${programaId}/inscripciones/${inscripcionId}/rechazar`,
            bloquear: (programaId: string, inscripcionId: string) => `/api/crowdpromotion/programas/${programaId}/inscripciones/${inscripcionId}/bloquear`,
            darDeBaja: (programaId: string, inscripcionId: string) => `/api/crowdpromotion/programas/${programaId}/inscripciones/${inscripcionId}/dar-de-baja`,
            misTareas: (programaId: string) => `/api/crowdpromotion/programas/${programaId}/mis-tareas`,
            completarTarea: (programaId: string, tareaId: string) => `/api/crowdpromotion/programas/${programaId}/tareas/${tareaId}/completar`,
            tareasPendientes: (programaId: string) => `/api/crowdpromotion/programas/${programaId}/tareas-pendientes`,
            validarTarea: (programaId: string, tareaPromotorId: string) => `/api/crowdpromotion/programas/${programaId}/tareas-promotor/${tareaPromotorId}/validar`,
            rechazarTarea: (programaId: string, tareaPromotorId: string) => `/api/crowdpromotion/programas/${programaId}/tareas-promotor/${tareaPromotorId}/rechazar`,
        },
        ...
        programaMetricas: (programaId: string) => `/api/crowdpromotion/programas/${programaId}/metricas`,

...
public class UpdateCampaniaCommandValidator : AbstractValidator<UpdateCampaniaCommand>
{
    public UpdateCampaniaCommandValidator()
    {
        RuleFor(x => x.Id)
            .NotEmpty()
        ...
        RuleFor(x => x.ImporteObjetivo)
            ...
            .When(x => x.ImporteObjetivo.HasValue);

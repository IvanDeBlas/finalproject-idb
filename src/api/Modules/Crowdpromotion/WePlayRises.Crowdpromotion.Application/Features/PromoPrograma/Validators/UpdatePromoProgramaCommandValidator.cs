...
public class UpdatePromoProgramaCommandValidator : AbstractValidator<UpdatePromoProgramaCommand>
{
    private readonly IPromoProgramaService _promoProgramaService;

    public UpdatePromoProgramaCommandValidator(IPromoProgramaService promoProgramaService)
    {
